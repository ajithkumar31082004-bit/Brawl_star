  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        >
          <h2 className="font-heading font-black text-2xl text-white mb-1">Welcome Back!</h2>
          <p className="text-slate-400 text-sm mb-8">Sign in to continue your adventure</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3.5 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-heading font-black text-base cursor-pointer shadow-lg shadow-purple-500/30 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
          ...
          <motion.button
            ...
            className="w-full py-3.5 bg-gradient-to-r from-amber-500 to-orange-500 text-black rounded-xl font-heading font-black text-sm cursor-pointer shadow-lg shadow-amber-500/30 flex items-center justify-center gap-2"
          >
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <motion.div
          ...
          className="glass-dark rounded-3xl p-8 border border-white/10"
        >
          <h2 className="font-heading font-black text-2xl text-white mb-1">Join the Battle!</h2>
          <p className="text-slate-400 text-sm mb-8">Create your account and start playing</p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <motion.button
              ...
              whileHover={{ scale: loading ? 1 : 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full py-3.5 bg-gradient-to-r from-amber-500 to-orange-500 text-black rounded-xl font-heading font-black text-base cursor-pointer shadow-lg shadow-amber-500/30 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
