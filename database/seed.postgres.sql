-- ========================================================================
-- BATTLEVERSE: 3V3 HERO ARENA — PostgreSQL Seed Data
...
('ev-1', 'double_trophies', 'DOUBLE TROPHIES', 'Earn 2X trophies on all 3v3 Crystal Clash matches this weekend!', 'Trophies', '2X Multiplier', '2X', '🏆', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '3 days', TRUE),
('ev-2', 'boss_fight', 'COLOSSUS BOSS FIGHT', 'Team up with 2 allies to bring down the legendary Arena Colossus!', 'Coins & Gems', '+5000 Coins', '1X', '💀', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '2 days', TRUE),
('ev-3', 'gem_hunt', 'ENERGY CRYSTAL HUNT', 'Collect crystals in Crystal Clash to unlock exclusive tier rewards.', 'Gems', '+500 Gems', '1X', '💎', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '4 days', TRUE),
('ev-4', 'power_surge', 'POWER SURGE', 'Heroes have 50% faster super charge for a limited time.', 'Power Points', '+300 Points', '1X', '⚡', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '1 day', TRUE),
('ev-5', 'ranked_rush', 'RANKED RUSH SPRINT', 'Top 100 players in this tournament receive exclusive seasonal rank badges.', 'Rank Badge', 'Diamond Foil', '1X', '💠', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '5 days', TRUE)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
